(function()
{
	...
	registerBlockType('mf/formview',
	{
		title: script_form_block_wp.block_title_view,
		description: script_form_block_wp.block_description_view,
		icon: 'forms',
		category: 'widgets',
		'attributes':
		{
			...
			return el(
				...
				[
					...
					el(
						'strong',
						{className: props.className},
						script_form_block_wp.block_title_view
					)
				]
			);
		},
